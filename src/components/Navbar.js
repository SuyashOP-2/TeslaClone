    ...
    <div>
      <div className="flex justify-between items-center font-bold px-12 p-4 text-sm ">
        ...
        <div className="lg:hidden">
          <button onClick={handleNav} className="inline-flex items-center rounded-md py-2 px-4 p-2 text-sm font-medium bg-black/5 shadow-sm hover:bg-black/10 bg-transparent">
            Menu
          </button>
        </div>
